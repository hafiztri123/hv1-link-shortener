...
func (m *mockUserService) Register(ctx context.Context, req user.CreateUserRequest) error {
	return m.err
}

func (m *mockUserService) Login(ctx context.Context, req user.UserLoginRequest) error {
	return m.err
}
